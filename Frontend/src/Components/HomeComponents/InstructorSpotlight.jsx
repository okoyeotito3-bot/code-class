export default function(){
    return(
        <section className="w-full flex flex-col gap-16 p-2  md:flex-row md:py-20 md:px-30 lg:py-20 lg:px-30">
            <img src="tutor.png.jpeg" alt="tutor" className="w-full h-auto object-cover rounded-md shadow-sm 120 lg:h-120" />
