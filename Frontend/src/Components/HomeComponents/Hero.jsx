...
export default function Hero() {
  return (
    <div className="w-full flex gap-16 p-4 md:px-20 md:py-24 lg:px-20 lg:py-24">
      <div className=" flex flex-col gap-8  items-start">
        ...
        <p className="font-['geist'] text-md text-[#94A3B8] leading-7">
        ...
        <div className="flex gap-1.5 md:gap-4 lg:gap-4 ">
          <Button
