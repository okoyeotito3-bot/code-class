...
export default function FeatureCourse() {
  return (
    <section className=" w-full flex flex-col gap-4 p-4 md:py-20 md:px-30 lg:py-10 lg:px-30 md:gap-16 lg:gap-16">
      <header className="w-full flex flex-col gap-4">
        <p className="text-[#FF4081] text-center font-[Geist-Mono] font-semibold text-[11px]">
          PREMIUM COHORT
        </p>
        <p className="font-geist font-extrabold text-2xl  text-[#F8FAFC] md:text-[36px] lg:text-[36px] ">
        ...
        <div className="flex flex-col gap-10 p-2">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col gap-1">
              <p className="font-geist font-bold text-[14px] text-[#F8FAFC]">
                Otito Okoye
              </p>
              <p className="font-normal font-[Geist-Mono] text-3 text-[#94A3B8]">
                Software Enginner
              </p>
            </div>
          </div>
          <div className="w-full flex items-center justify-between gap-2 md:pr-6 lg:pr-6">
            <div className="flex flex-col items-start gap-1 whitespace-nowrap">
              <p className="text-[#64748B] text-3 font-gesit font-semibold">
                Price
              </p>
            ...
            <Button
              text="Enroll Now"
              to="/Register"
              className="bg-[#2979FF] py-3 px-6 rounded-md mt-auto font-geist font-semibold text-[14px] text-[#F8FAFC] cursor-pointer  hover:bg-[#1D64D8] whitespace-nowrap"
            />
          </div>
        </div>
