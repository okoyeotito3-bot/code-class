    ...
    return(
        <section className=" w-full flex flex-col gap-16 py-4 px-2 md:py-[80px] md:px-[120px] lg:py-[40px] lg:px-[120px]">
            <header className="w-full flex flex-col gap-4 items-center">
                ...
                <p className="font-geist font-extrabold text-[36px] text-[#F8FAFC]">Our Best-Selling Syllabus</p>
            </header>
            ...
            <div className="w-full flex flex-col md:flex-row lg:flex-row">
                ...
                <div className='w-full flex items-center justify-between  pr-6'>
                    ...
                    <Button 
                    text='Enroll Now'
                    className='bg-[#2979FF] py-3 px-6 rounded-[6px] mt-auto font-geist font-semibold text-[14px] text-[#F8FAFC] cursor-pointer  hover:bg-[#1D64D8]'
                    />
                </div>
                </div>
